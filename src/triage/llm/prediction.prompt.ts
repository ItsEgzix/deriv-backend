...
export const SYSTEM_PROMPT = `You are a support-triage classifier for a financial-services product.
...
export function buildUserPrompt({ config, tickets }: BatchPromptInputs): string {
